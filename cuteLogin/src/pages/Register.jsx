...
export default function Register(){
    ...
    return(
        <div>
            <div className="card">
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start' }}>
                    <h6 style={{ fontSize: '14px', marginLeft: '32px', color: '#DF1B7A' }}>
                        <MailOutlineIcon style={{ marginLeft: '-20px', marginBottom: '-5px', fontSize: '20px' }} /> Write your email</h6>
                    <Input
                        type="email"
                    ...
                    <h6 style={{ fontSize: '14px', marginLeft: '32px', color: '#DF1B7A', marginTop: '17px' }}>
                        <LockOutlineIcon style={{ marginLeft: '-25px', marginBottom: '-5px', fontSize: '22px' }} /> Create a Password</h6>
                    <Input
                        type="password"
                    ...
                    />
                     <h6 style={{ fontSize: '14px', marginLeft: '32px', color: '#DF1B7A', marginTop: '17px' }}>
                        <LockOutlineIcon style={{ marginLeft: '-25px', marginBottom: '-5px', fontSize: '22px' }} /> Confirm Password</h6>
                    <Input
                        type="password"
            ...
            <h6 style={{ fontSize: '13px', fontWeight: 'normal', color: '#DF1B7A' }}>You have an account?<a onClick={() => navigate('/')}
                style={{ fontWeight: 'bold', color: '#DF1B7A' }}>Log In</a></h6>
        </div>
    )
}